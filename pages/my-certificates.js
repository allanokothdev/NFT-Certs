...
import { nftAddress, nftTransferAddress } from "../config";
...
export default function CreatorDashboard() {
    ...
    async function loadNFTs() {
        ...
        const marketContract = new ethers.Contract(nftTransferAddress, NFTTransfer, signer);
        ...
        const data = await marketContract.fetchStudentCertificates();
